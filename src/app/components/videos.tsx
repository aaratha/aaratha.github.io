...
export default function Videos() {
  ...
  return (
    <div className=" md:border-l-2 list-shadow md:pl-10 md:border-r-2 border-fg h-screen md:w-[55vw] flex flex-col md:overflow-scroll md:overflow-x-hidden scrollbar-thin scrollbar-track-orange-200 scrollbar-thumb-amber-900 pr-8 md:pr-10 pt-8 pb-4 md:pt-0 ">
