...
export default function Videos() {
    ...
    return (
        <div className=" h-full w-full flex flex-col pt-10 pb-0 pr-10 md:p-20 md:pl-0">
            ...
            <div className='flex flex-row items-center mt-1 md:mt-0 overflow-scroll overflow-y-hidden scrollbar-track-orange-200 scrollbar-thumb-amber-900 scrollbar-thin pb-2 pt-2'>
