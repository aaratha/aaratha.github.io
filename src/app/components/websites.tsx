    ...
    return (
        <div className="md:border-l-2 md:pl-10 md:border-r-2 border-amber-900 h-screen md:w-[55vw] flex flex-col md:overflow-scroll md:overflow-x-hidden scrollbar-thin scrollbar-track-orange-200 scrollbar-thumb-amber-900 pr-8 md:pr-10 pt-8 md:pt-0">
            <div className='flex flex-col'>
                <a href='https://vicrecords.netlify.app/'><Image src={img4} alt='vic-records' className='rounded-lg mt-5 mb-5 border-2 border-amber-900 hover:scale-95 transition-all'></Image></a>
